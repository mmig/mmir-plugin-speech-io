...
export class SelectionUtil {
  ...
  private _selMarkerStart: HTMLElement;
  private _selMarkerEnd: HTMLElement;
  private _selMarkerBlock: HTMLElement;

  constructor(private unitUtil: typeof LengthModule, private caretPos: typeof CaretPositionModule){}
