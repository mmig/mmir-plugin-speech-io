...
//	}
/** @memberOf Emma# */
function setSpeechRecognition(emmaData, _event, data, keepExistingFunction) {
    ...
    var result = data[0], score = data[1], type = data[2], alternatives = data[3], unstable = data[4];
    var asrList = [];
...
/** @memberOf Emma# */
function setSpeechUnderstanding(emmaData, _event, data, keepExistingFunction) {
...
var EmmaUtil = /** @class */ (function () {
    ...
    EmmaUtil.prototype.setSpeechRecognition = function (emmaData, event, data, keepExistingFunction) {
        setSpeechRecognition(emmaData.interpretation, event, data, keepExistingFunction);
    };
    EmmaUtil.prototype.setSpeechUnderstanding = function (emmaData, event, data, keepExistingFunction) {
    ...
    EmmaUtil.prototype._setEmmaFuncData = function (emmaEvent, funcName, funcData, isOverwrite) {
