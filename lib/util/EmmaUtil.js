...
//	}
/** @memberOf Emma# */
function setSpeechRecognition(emmaData, _event, data) {
...
/** @memberOf Emma# */
function setSpeechUnderstanding(emmaData, _event, data) {
...
var EmmaUtil = /** @class */ (function () {
    ...
    EmmaUtil.prototype.isTactileEvent = function (emmaData) {
        if (emmaData.interpretation.gesture)
            return true;
        return false;
    };
    EmmaUtil.prototype.isSpeechEvent = function (emmaData) {
        if (emmaData.interpretation['function'])
            return true;
        return false;
    };
    EmmaUtil.prototype.setSpeechRecognition = function (emmaData, event, data) {
        setSpeechRecognition(emmaData.interpretation, event, data);
    };
    EmmaUtil.prototype.setSpeechUnderstanding = function (emmaData, event, data) {
