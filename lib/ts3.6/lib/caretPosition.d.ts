 ...
 * @param [options] additional options
 */
export function styleDiv(element: HTMLInputElement | HTMLTextAreaElement, position: number, div: HTMLElement, options?: CaretOptions): void;
/**
 ...
 * @param [options] additional options
 */
export function updateCoordinates(element: HTMLInputElement | HTMLTextAreaElement, position: number, div: HTMLElement, options?: CaretOptions): CaretPosition;
/**
 ...
 * @param [options] additional options
 */
export function getCoordinates(element: HTMLInputElement | HTMLTextAreaElement, position: number, options?: CaretOptions): CaretPosition;
