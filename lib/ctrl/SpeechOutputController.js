...
exports.SpeechOutputController = void 0;
var SubscriptionUtil_1 = require("../util/SubscriptionUtil");
var SpeechOutputController = /** @class */ (function () {
    function SpeechOutputController(prompt, mmirProvider, ignoreMmirReady) {
        var _this = this;
        this.prompt = prompt;
    ...
    SpeechOutputController.prototype.init = function (mmirp) {
        this._speechEventSubscriptions = SubscriptionUtil_1.SubscriptionUtil.subscribe(mmirp.speechEvents, ['read'], this);
    };
