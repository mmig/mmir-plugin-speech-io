...
var SpeechInputController = /** @class */ (function () {
    ...
    mmirProvider, dictTargetHandler) {
        ...
        mmirProvider.ready().then(function (mmirp) {
            ...
            _this.dictationResults = mmirProvider.speechEvents.dictationResult.pipe(operators_1.map(function (dictation) { return _this._processDictationResult(dictation); }));
