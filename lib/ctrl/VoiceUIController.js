...
var VoiceUIController = /** @class */ (function () {
    ...
    VoiceUIController.prototype.resetDictationHandlers = function (target, doNotResetActiveCss, destroyDictationTarget) {
        var _a, _b;
        if (!target) {
            this.dictTargetHandler.reset();
        }
            ...
            if (handler) {
                if (!doNotResetActiveCss) {
                    (_a = handler.nativeInput) === null || _a === void 0 ? void 0 : _a.classList.remove(consts_1.SPEECH_ACTIVE);
                    (_b = handler.nativeCtrl) === null || _b === void 0 ? void 0 : _b.classList.remove(consts_1.SPEECH_ACTIVE);
                }
