...
var MmirService = /** @class */ (function () {
    ...
    MmirService.prototype.init = function (appConfig) {
        ...
        if (this._isCreateAppConfigImpl === true && !this.appConfig) {
            ...
            initVuiDebugPromise = new Promise(function (resolve) {
        ...
        initVuiDebugPromise = initVuiDebugPromise ? initVuiDebugPromise.then(function () { return _this.initDebugVui(); }) : Promise.resolve(this.initDebugVui());
        if (!this._initialize) {
            this._initialize = initVuiDebugPromise.then(function () { return _this.mmirInit(); });
        }
        ...
        return new Promise(function (resolve) {
            _this._mmir.ready(function () {
                ...
                SpeechIoManager_1.createSpeechioManager(_this._mmir, _this.isDebugVui ? 'debug' : void (0)).then(function () {
                    ...
                    SpeechIoManager_1.raiseInternal(_this.mmir.speechioEngine, 'init', {
                    ...
                    if (_this.mmir.conf.getBoolean([consts_1.PLUGIN_ID, 'preventDialogManagerInit']) !== true) {
                        //circumvent message-queue for init-event:
                        // (this allows to pass non-stringified and non-stringifyable object instances)
                        SpeechIoManager_1.raiseInternal(_this.mmir.dialogEngine, 'init', {
                            appConfig: _this.appConfig,
                            mmir: _this._mmir,
                            emma: dlg.emma
                        });
